...
La especificación de requisitos del \emph{proxy} inverso se va a llevar a cabo a través de los casos de uso que debe cubrir. Adicionalmente, se expondrán una serie de requisitos funcionales y no funcionales que el producto deberá satisfacer.

		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% CASOS DE USO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

		\subsection{Casos de uso}

Los casos de uso van a ser expuestos a continuación con un diagrama de casos de uso, figura \ref{diagramaCasosDeUso}, y en formato de tabla, indicando un identificador, un nombre, el actor que lo lleva a cabo y una breve descripción:
