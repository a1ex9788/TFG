...
Para empezar, se crea un proyecto web básico de .NET, tal y como se observa en la figura.
...
\caption{Creación de un proyecto web vacío.}
	\label{ejemploYARP_creacionProyecto}
\end{figure}
...
\caption{Consulta Postman.}
	\label{ejemploYARP_consultaPostman}
\end{figure}
