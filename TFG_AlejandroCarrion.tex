...
La especificación de requisitos del \emph{proxy} inverso se va a detallar mediante los casos de uso a cubrir y las pruebas de aceptación que debe satisfacer. Los primeros permitirán entender qué funcionalidades debe tener el producto \emph{software} y con las segundas se establecerán, de manera informal, los límites de lo que se considerará como funcionamiento correcto e incorrecto.
...
Para exponer las pruebas de aceptación, se va a utilizar una tabla para cada una y estas contendrán ...
