...
La especificación de requisitos del \emph{proxy} inverso se va a detallar mediante los casos de uso que debe cubrir. Adicionalmente, se expondrán una serie de características concretas y requisitos no funcionales que el producto deberá satisfacer.

		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% CASOS DE USO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

		\subsection{Casos de uso}

Los casos de uso van a ser expuestos a continuación en formato de tabla, indicando su identificador, su nombre, el actor que lo lleva a cabo y una breve descripción:
...
\\ \hline \end{tabular} \end{center}
		...
		\subsection{Características concretas}

El \emph{proxy} inverso ha de cumplir una serie de características concretas que no son propiamente casos de uso pero que se considera de interés mencionarlas, pues son relevantes para su funcionalidad. Complementan así los casos de uso y ayudarán también a comprender qué debe hacer el producto y cómo. 

Estos aspectos van a ser representados...

- Carga de configuración dinámica
- Comunicación entre UI y microservicios (interconecta microservicios)
- Instancia exclusiva para la comunicación entre microservicios
- Multiinstancia de microservicios
- Multiinstancia de \emph{proxies} inversos
- Segundo nivel de enrutamiento
...
\caption{ISO/IEC 25010. Imagen de \url{https://iso25000.com/index.php/normas-iso-25000/iso-25010}.}
	\label{iso25010}
\end{figure}
...
\\ \hline
\textbf{Descripción} & Se debe tener un sistema de autenticación que no permita redirigir peticiones sin autenticar.
\\ \hline
\textbf{Motivación} & Impedir que peticiones ajenas puedan ser redirigidas para evitar posibles ataques.
\\ \hline \end{tabular} \end{center}
...
\\ \hline
\textbf{Descripción} & El enrutamiento no debe ralentizar las peticiones en exceso de forma que las peticiones enrutadas no tomen un tiempo superior al 115\% del tiempo que tardaría la petición si no pasara por el \emph{proxy} inverso.
\\ \hline
...
Decir si los objetivos se han cumplido. Valorar el cumplimiento de los casos de uso y de los requisitos no funcionales.
