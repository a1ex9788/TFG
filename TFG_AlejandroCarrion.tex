...
La especificación de requisitos del \emph{proxy} inverso se va a detallar mediante los casos de uso que debe cubrir. Adicionalmente, se expondrán una serie de requisitos no funcionales que el producto debería satisfacer.
...
Sobre el \emph{proxy} inverso que atañe a este trabajo se imponen los siguientes requisitos no funcionales. Se detallan mediante un identificador, un nombre, la característica de la ISO a la que hacen referencia, una breve descripción y el motivo por el cual es necesario satisfacerlos:
