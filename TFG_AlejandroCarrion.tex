...
Tras comentar algunas aplicaciones y servicios que se pueden utilizar como \emph{proxy} inverso, se presenta a continuación una comparativa de dichas herramientas para mostrar de manera concreta las diferencias entre ellas. Para cada una de ellas se indica el patrón que implementa, el nivel del modelo OSI sobre el que actúa, el coste de implantación, si permite recarga de configuración dinámica, si permite mucha personalización y la facilidad para ponerla en marcha de una manera rápida:
