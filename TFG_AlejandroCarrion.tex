...
Una vez comentado la elección que finalmente se hizo y el porqué, se va a introducir un ejemplo de uso básico de YARP para dar una visión general de lo que es capaz de hacer esta librería. De este modo, será más fácil comprender el funcionamiento del \emph{proxy} inverso desarrollado.

En lineas generales, empezar a utilizar Yarp no es nada difícil, en un par de horas se puede llegar a tener un \emph{proxy} inverso sencillo funcionando, si bien utilizar características más avanzadas o personalizarlo en función de las necesidades particulares es más complejo.

Para empezar, se crea un proyecto web básico de .NET

Se puede configurar a través de código pero requiere algo más de trabajo y en esta demostración no se va a utilizar por simplicidad.

\begin{figure}[ht]
\centering
\label{figura:ejemploYARP_creacionProyecto}
\includegraphics[width=1\textwidth]{imagenes/ejemploYarp/creacionProyecto_proyectoWeb}
\includegraphics[width=1\textwidth]{imagenes/ejemploYarp/creacionProyecto_plantillaVacia}
\caption{Creación de un proyecto web vacío.}
\end{figure}

\begin{figure}[ht]
\centering
\label{figura:ejemploYARP_solucion}
\includegraphics[width=0.35\textwidth]{imagenes/ejemploYARP/solucion}
\caption{Solución proyecto.}
\end{figure}

\begin{figure}[ht]
\centering
\label{figura:ejemploYARP_instalacionNuGet}
...
\begin{figure}[ht]
\centering
\label{figura:ejemploYARP_startup}
\includegraphics[width=0.7\textwidth]{imagenes/ejemploYARP/startup}
\caption{Clase \emph{Startup}.}
\end{figure}

\begin{figure}[ht]
\centering
\label{figura:ejemploYARP_appsettings}
\includegraphics[width=0.50\textwidth]{imagenes/ejemploYARP/appsettings}
\caption{Fichero \emph{appsettings}.}
\end{figure}

\begin{figure}[ht]
\centering
\label{figura:ejemploYARP_servicios_preparacion}
\includegraphics[width=1\textwidth]{imagenes/ejemploYARP/servicios_preparacion}
\caption{Servicios preparados.}
\end{figure}

\begin{figure}[ht]
\centering
\label{figura:ejemploYARP_consultaPostman}
\includegraphics[width=1\textwidth]{imagenes/ejemploYARP/consultaPostman}
\caption{Consulta Postman.}
\end{figure}

\begin{figure}[ht]
\centering
\label{figura:ejemploYARP_servicios_funcionando}
\includegraphics[width=1\textwidth]{imagenes/ejemploYARP/servicios_funcionando}
\caption{Servicios con consultas hechas.}
\end{figure}
