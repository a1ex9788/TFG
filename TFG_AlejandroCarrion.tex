...
% TODO: Añadir foto de las columnas del trello
% TODO: Pensar si crear una columna para especificar las UTs
...
% TODO: Modificar la figura. Pensar si crear una columna para especificar las UTs
...
% TODO: Añadir figura solución prototipo a mano.
...
% TODO: Añadir figura solución prototipo autogenerado.
...
% TODO: Sacar foto del código y comentarlo mejor
...
% TODO: Comprobar porcentaje y mostrar alguna gráfica o algo
...
También se creyó conveniente estandarizar el tratamiento de las rutas base de las peticiones que representan una ruta. Esto se hizo para hacer el \emph{proxy} inverso más robusto y evitar posibles malentendidos con YARP, pues espera recibir las rutas de una manera concreta y no otra, por ejemplo, utilizando barras como separadores de ruta en lugar de barras invertidas. Para ello se creó un método \emph{GetNormalizedPath}, en la clase \emph{RouteUtils}, que normaliza una ruta dada según el esquema que YARP acepta. El método en cuestión se muestra en la figura (TODO: Añadir figura).

% TODO: Añadir figura

Además, se consideró oportuno crear una serie de pruebas unitarias para las acciones de añadir y eliminar rutas y para el método \emph{GetNormalizedPath}, recién comentado en el párrafo anterior. Se entrará más en detalle acerca de estas pruebas en el apartado de pruebas \ref{pruebas}.
...
% TODO: Esquema dos niveles de proxy inverso
...
% TODO: Esquema del recorrido completo de una petición que viene de la UI y pasa por varios microservicios.
